...
var str = try! ArabicToRoman.romanNumberFromArabicNumber(1689)



//Here you can try converting strings which represents roman numbers into arabic numbers.
//All numbers between I and MMMCMXCIX are supported. Both lowercase and uppercase characters are acceptable.
